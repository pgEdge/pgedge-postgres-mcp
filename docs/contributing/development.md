...
- **Unit Tests**: [config_test.go](https://github.com/pgEdge/pgedge-postgres-mcp/blob/main/internal/chat/config_test.go) - Configuration loading and validation
- **Integration Tests**: [client_integration_test.go](https://github.com/pgEdge/pgedge-postgres-mcp/blob/main/internal/chat/client_integration_test.go) - Client connection, LLM initialization, command handling, query processing
- **UI Tests**: [ui_test.go](https://github.com/pgEdge/pgedge-postgres-mcp/blob/main/internal/chat/ui_test.go) - Color output, animations, prompts
- **LLM Tests**: [llm_test.go](https://github.com/pgEdge/pgedge-postgres-mcp/blob/main/internal/chat/llm_test.go) - Anthropic and Ollama client functionality
- **MCP Client Tests**: [mcp_client_test.go](https://github.com/pgEdge/pgedge-postgres-mcp/blob/main/internal/chat/mcp_client_test.go) - HTTP and stdio communication
...
- [MCP Protocol Reference](../developers/mcp-protocol.md) - MCP protocol details
