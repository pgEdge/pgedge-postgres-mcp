...
If you have issues using the web client, visit [the Troubleshooting page](troubleshooting.md) for help.
...
When you are writing your sample queries, keep in mind that the more specific your query is, the more targeted the response will be.  For example, some well-formed queries are:
...
Click the `Settings` icon (a gear) to access preferences:
...
**Automatically Saving Conversations**
...
**Preserving Conversation Privacy and Security**
