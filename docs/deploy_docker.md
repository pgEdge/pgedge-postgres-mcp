...
After installing the prerequisites, choose your deployment method:

- [Deploy into a Docker Container](#docker-deployment)
...
Clone the `pgedge-mcp` repository and navigate into the repository's root directory:
